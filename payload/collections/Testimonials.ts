...
export const Testimonials: CollectionConfig = {
  ...
  admin: { useAsTitle: 'studentName', defaultColumns: ['studentName', 'university', 'country', 'published', 'sortOrder'] },
  ...
  fields: [
    ...
    { name: 'university', type: 'relationship', relationTo: 'universities' },
    {
      ...
      admin: { description: 'Optional. Show this review on that country page.' },
    },
