...
export default async function UniversitiesPage() {
  ...
  return <><SiteHeader/><main>
    <section className="border-b border-[var(--border)]"><div className="mx-auto max-w-7xl px-5 py-16 md:py-20 lg:px-8 lg:py-24">
    ...
    <section><div className="mx-auto max-w-7xl px-5 py-16 lg:px-8 lg:py-24">
      {universities.length ? <UniversityExplorer universities={universities}/> :
        <EmptyState icon={<GraduationCap size={24} />} title="Let's find your university together." description="Our university directory is being prepared. An adviser can help you explore destinations and build a shortlist that fits your goals."><ApplyNowDialog triggerContent="Get university guidance" /></EmptyState>}
    </div></section>
